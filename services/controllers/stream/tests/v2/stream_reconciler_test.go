...
func Test_UpdatePhase_New_To_Suspended(t *testing.T) {
	// Arrange
	k8sClient := helpers.SetupClientFromBuilders(nil, v3.NewMockStreamDefinitionLayoutV2Builder(objectName), nil)
...
func Test_UpdatePhase_New_To_Pending(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithSuspendedSpec(false)
...
func Test_UpdatePhase_New_To_Pending_with_schedule(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithSuspendedSpec(false).WithSchedule("* * * * *")
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, nil)
...
func Test_UpdatePhase_New_To_Pending_with_no_backend(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithSuspendedSpec(false).WithNoBackend()
...
func Test_UpdatePhase_Pending_To_Running_no_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).
...
func Test_UpdatePhase_Pending_To_Running_not_recreate_job(t *testing.T) {
	...
	streamDefinitionBuilder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).
		WithPhase(stream.Pending).
		WithName(objectName)
...
func Test_UpdatePhase_Pending_To_Backfilling_no_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Pending).WithV2BackfillJobTemplateRef(batchJobTemplateName)
...
func Test_UpdatePhase_Pending_To_Backfilling_recreate_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Pending).WithV2BackfillJobTemplateRef(backfillJobTemplateName)
...
func Test_UpdatePhase_Running_To_Suspended_no_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Running).WithSuspendedSpec(true)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, nil)
...
func Test_UpdatePhase_Running_To_Suspended_to_Pending(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Suspended).WithSuspendedSpec(false)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, nil)
...
func Test_UpdatePhase_Suspended_To_Suspended_to_Pending_With_BFR(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Suspended).WithSuspendedSpec(true)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, helpers.NewFakeClientResourcesBuilder().WithBackfillRequest(objectName))
...
func Test_UpdatePhase_Running_To_Pending_with_schedule(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Running).WithSuspendedSpec(false).WithSchedule("* * * * *")
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, helpers.NewFakeClientResourcesBuilder().WithOutdatedJob(objectName))
...
func Test_UpdatePhase_Running_with_BackfillRequest_no_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Running).WithSuspendedSpec(false)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, helpers.NewFakeClientResourcesBuilder().WithBackfillRequest(objectName))
...
func Test_UpdatePhase_Suspended_without_BackfillRequest_without_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Suspended)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, nil)
...
func Test_UpdatePhase_Backfilling_To_Pending_with_job_completed(t *testing.T) {
	// Arrange
	streamResource := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Backfilling).WithSuspendedSpec(false)
...
func Test_UpdatePhase_Backfilling_To_Pending_with_deleted_bfr(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Backfilling).WithSuspendedSpec(false)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, helpers.NewFakeClientResourcesBuilder().WithOutdatedJob(objectName))
...
func Test_UpdatePhase_Backfilling_To_Pending_with_schedule(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Backfilling).WithSuspendedSpec(false).WithSchedule("* * * * *")
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, helpers.NewFakeClientResourcesBuilder().WithOutdatedJob(objectName))
...
func Test_UpdatePhase_Backfilling_To_Suspended(t *testing.T) {
	// Arrange
	streamResource := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).
		WithPhase(stream.Backfilling).
...
func Test_UpdatePhase_Failed_to_Failed(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Failed)
...
func Test_UpdatePhase_Failed_to_Failed_without_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Failed).WithSuspendedSpec(false)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, nil)
...
func Test_UpdatePhase_Failed_to_Suspended_without_job(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Failed).WithSuspendedSpec(true)
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, nil)
...
func Test_UpdatePhase_Scheduled_to_Suspended(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Scheduled).WithSuspendedSpec(true).WithSchedule("* * * * *")
...
func Test_UpdatePhase_Scheduled_to_Backfilling(t *testing.T) {
	// Arrange
	builder := v3.NewMockStreamDefinitionLayoutV2Builder(objectName).WithPhase(stream.Scheduled).WithSuspendedSpec(false).WithSchedule("* * * * *")
	k8sClient := helpers.SetupClientFromBuilders(nil, builder, helpers.NewFakeClientResourcesBuilder().WithBackfillRequest(objectName))
