...
// BackfillRequest constructs a declarative configuration of the BackfillRequest type for use with
// apply.
func BackfillRequest(name, namespace string) *BackfillRequestApplyConfiguration {
	b := &BackfillRequestApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("BackfillRequest")
...
func (b *BackfillRequestApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
