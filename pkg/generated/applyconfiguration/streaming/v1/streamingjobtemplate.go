...
func StreamingJobTemplate(name, namespace string) *StreamingJobTemplateApplyConfiguration {
	b := &StreamingJobTemplateApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("StreamingJobTemplate")
...
func (b *StreamingJobTemplateApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
