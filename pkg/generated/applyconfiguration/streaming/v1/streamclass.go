...
// StreamClass constructs a declarative configuration of the StreamClass type for use with
// apply.
func StreamClass(name, namespace string) *StreamClassApplyConfiguration {
	b := &StreamClassApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("StreamClass")
...
func (b *StreamClassApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
