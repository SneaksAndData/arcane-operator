...
func NewForConfig(c *rest.Config) (*StreamingV1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new StreamingV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*StreamingV1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &StreamingV1Client{client}, nil
}

// NewForConfigOrDie creates a new StreamingV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *StreamingV1Client {
...
// New creates a new StreamingV1Client for the given RESTClient.
func New(c rest.Interface) *StreamingV1Client {
	return &StreamingV1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := streamingv1.SchemeGroupVersion
...
func (c *StreamingV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
