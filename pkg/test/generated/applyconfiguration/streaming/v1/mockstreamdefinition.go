...
// MockStreamDefinition constructs a declarative configuration of the MockStreamDefinition type for use with
// apply.
func MockStreamDefinition(name, namespace string) *MockStreamDefinitionApplyConfiguration {
	b := &MockStreamDefinitionApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("MockStreamDefinition")
...
func (b *MockStreamDefinitionApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
